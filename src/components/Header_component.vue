<template>
     <header>
      <nav class="header-navbar">
        <div class="logo"> <img src="https://i.ibb.co/CJyvtyM/image-Photoroom.png" alt=""></div>
        <ul>
          <li><a href="">Home</a></li>
          <li><a href="">Sale</a></li>
...
<style>
   header {
    ...
    .dropdown-menu {
        ...
        box-shadow: 0px 28px 36px 0px rgba(0, 0, 0, 0.117);
        z-index: 1000;
        margin-top: 12.5vw;
        /* 240px */
        list-style: none;
    ...
    .line {
        ...
        height: 1.04vw;
        /* 20px */
        background-color: rgba(94, 94, 94, 0.334);
    }
