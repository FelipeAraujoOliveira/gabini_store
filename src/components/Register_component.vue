      ...
      <div class="form">
        <form>
          ...
          <div class="form-step" v-show="currentStep === 0">
            ...
            <input type="text" class="form-control" v-model="formData.telefone" placeholder="Telefone" required />
            <input type="text" class="form-control" v-model="formData.nomeDeUsuario" placeholder="Nome de usuário"
              required />
          </div>
  
          <!-- Passo 2 -->
          <div class="form-step" v-show="currentStep === 1">
            <input type="text" class="form-control" v-model="formData.enderecos[0].rua" placeholder="Rua" required />
            ...
            <input type="text" class="form-control" v-model="formData.enderecos[0].estado" placeholder="Estado"
              required />
            <input type="text" class="form-control" v-model="formData.enderecos[0].cep" placeholder="CEP" required />
          </div>
          ...
          <div class="form-step" v-show="currentStep === 2">
            ...
            <input type="password" class="form-control" v-model="confirmPassword" placeholder="Confirme sua senha"
              required />
            <input type="date" class="form-control" v-model="formData.dataNascimento" placeholder="Data de nascimento"
              required />
            <input type="text" class="form-control" v-model="formData.cpf" placeholder="CPF" required />
            <input type="text" class="form-control" v-model="formData.url_foto_perfil" placeholder="url_foto_perfil"
              required />
          </div>
